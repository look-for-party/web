...
<!-- TODO: Adopt Skeleton styling, maybe break out of root layer?, follow https://dev.to/enter -->
			...
			<div class="p-6 space-y-4 md:space-y-6 sm:p-8">
				...
				<div class="flex flex-col space-y-6">
					<a href="#top" class="btn variant-filled-surface">
						<span> (icon) </span><span>Continue with Google</span></a
					>
					<a href="#top" class="btn variant-filled-surface">
						<span> (icon) </span><span>Continue with Facebook</span></a
					>
					<a href="/sign-in/github" class="btn variant-filled-surface">
						<span> (icon) </span><span>Continue with GitHub</span></a
					>
				</div>
